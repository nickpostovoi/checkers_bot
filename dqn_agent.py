...
class DQN_agent:
    ...
    def act(self, state):
        ...
        # masking out illegal moves (set the values of illegal actions to a large negative number making them unlikely to be selected)
        mask = np.ones_like(act_values) * -1e5
